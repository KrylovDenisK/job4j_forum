        ...
        <div class="card-body">
            <form action="<c:url value="/post/save"/>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="desc" name="desc" placeholder="О чем этот пост???"></textarea>
                </div>
                <div class="form-group" align="center">
                    <input type="submit" class="btn btn-primary" name="create" value="Создать новый пост"/>
                </div>
            </form>
        </div>
    </div>
